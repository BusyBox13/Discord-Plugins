 ...
 module.exports = (() => {
    ...
    const config = 
		...
		info: 
		{
			...
			authors: [
				{
					name: "WarMachine#9792",
					github_username: "BusyBox13"
				}
			], 
			version: "0.0.0.4", 
			description: "Plays Memetastic sounds depending on what is being sent in chat.", 
			github: "https://github.com/BusyBox13/Discord-Plugins/blob/main/MemeSound/MyMemeSound.plugin.js", 
			github_raw: "https://raw.githubusercontent.com/BusyBox13/Discord-Plugins/main/MemeSound/MyMemeSound.plugin.js"
		}, 
		defaultConfig: [
			{
				id: "setting", 
		...
		changelog: [
			{
				title: "MAJ", 
				items: [
					"Tentative de mise à jour automatique du plugin", 
					"contient 4 sons"
				]
			}
		]
